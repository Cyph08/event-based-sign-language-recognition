"""
routing/B2_dvs_hand.py
--------------
DVS128 Gesture · HAND region only · standard net.

    python B2_dvs_hand.py                    # full run
    python B2_dvs_hand.py --quick            # fast sanity check
    python B2_dvs_hand.py --mode hand        # switch input (full | hand | crop64)
    python B2_dvs_hand.py --seed 1           # another seed, for error bars
"""
...
if __name__ == "__main__":
    ...
    a = ap.parse_args()
    train_and_eval(code="B2", ds="dvs", mode=a.mode, net=a.net or "standard",
