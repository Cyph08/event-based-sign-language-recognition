"""
routing/C2_dvs_small.py
---------------
DVS128 Gesture · SMALL net. Use --mode to pick the input.

    python C2_dvs_small.py                    # full run
    python C2_dvs_small.py --quick            # fast sanity check
    python C2_dvs_small.py --mode hand        # switch input (full | hand | crop64)
    python C2_dvs_small.py --seed 1           # another seed, for error bars
"""
...
if __name__ == "__main__":
    ...
    a = ap.parse_args()
    train_and_eval(code="C2", ds="dvs", mode=a.mode, net=a.net or "small",
