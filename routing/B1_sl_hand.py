"""
routing/B1_sl_hand.py
-------------
SL-Animals · HAND region only · standard net — does the hand carry the signal?

    python B1_sl_hand.py                    # full run
    python B1_sl_hand.py --quick            # fast sanity check
    python B1_sl_hand.py --mode hand        # switch input (full | hand | crop64)
    python B1_sl_hand.py --seed 1           # another seed, for error bars
"""
...
if __name__ == "__main__":
    ...
    ap.add_argument("--mode", default="hand", choices=["full", "hand", "crop64"])
    ...
    a = ap.parse_args()
    train_and_eval(code="B1", ds="sl", mode=a.mode, net=a.net or "standard",
