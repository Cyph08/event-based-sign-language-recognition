"""
routing/A2_dvs_full.py
--------------
DVS128 Gesture · FULL frame · standard net — the accuracy ceiling for dataset 2.

    python A2_dvs_full.py                    # full run
    python A2_dvs_full.py --quick            # fast sanity check
    python A2_dvs_full.py --mode hand        # switch input (full | hand | crop64)
    python A2_dvs_full.py --seed 1           # another seed, for error bars
"""
...
if __name__ == "__main__":
    ...
    a = ap.parse_args()
    train_and_eval(code="A2", ds="dvs", mode=a.mode, net=a.net or "standard",
